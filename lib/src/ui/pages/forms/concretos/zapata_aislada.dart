...
class ZapataAisladaPage extends StatefulWidget {
  final String title;
  const ZapataAisladaPage({
    super.key,
    required this.title,
  });

  @override
  State<ZapataAisladaPage> createState() => _ZapataAisladaPageState();
}

class _ZapataAisladaPageState extends State<ZapataAisladaPage> with FormValidator {
